...
//typedef ImFontAtlas::CustomRects CustomRects;
typedef ImGuiTextFilter::ImGuiTextRange TextRange;
typedef ImGuiStorage::ImGuiStoragePair Pair;
...
//typedef ImVector<CustomRects> ImVector_CustomRects;
...
CIMGUI_API void ImFont_AddGlyph(ImFontConfig* src_cfg, ImFont* self,ImWchar c,float x0,float y0,float x1,float y1,float u0,float v0,float u1,float v1,float advance_x);
...
//IMGUI_API int ImVector_CustomRect_size_in_bytes(const ImVector_CustomRect* self);
